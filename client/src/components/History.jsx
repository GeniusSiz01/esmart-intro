            ...
            <div className='container'>
                ...
                <Feed>
                    <Feed.Event>
                        ...
                        <Feed.Content>
                            <Feed.Summary>
                                <Feed.User> <a href="#">Jason Gama</a> </Feed.User> collector
                    ...
                    <Feed.Event>
                        ...
                        <Feed.Content>
                            <Feed.Summary>
                                <a href='#'>Sibusiso Nkosi</a> collector <a></a>
                    ...
                    <Feed.Event>
                        ...
                        <Feed.Content>
                            <Feed.Summary>
                                <a href='#'>Mthabiseng Mpapa</a> collector <a></a>
                    ...
                    <Feed.Event>
                        ...
                        <Feed.Content>
                            <Feed.Summary>
                                <a href='#'>Khuzwayo</a> collector <a></a>
